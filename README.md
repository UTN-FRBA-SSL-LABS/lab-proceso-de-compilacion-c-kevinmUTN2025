...
> **R:** Porque al procesar se agregan muchas lineas al codigo, por eso el archivo es mas grande.
...
> **R:** Indica de que archivo y linea proviene cada parte del codigo, en este caso, "printf" sale de la libreria "stdio.h"
...
> **R:** Estas instrucciones preparan a la funcion para que se ejecute, ya que se guarda el valor anterior del registro en pila y se organiza lo necesario para trabajar dentro de la misma
